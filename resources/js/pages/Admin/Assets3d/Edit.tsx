...
export default function EditAsset3d({ asset }: EditAsset3dProps) {
       ...
       return (
              <AppLayout breadcrumbs={[
                     ...
                     { title: 'Editar Modelo', href: `/admin/assets3d/${asset.id}/edit` }
              ]}>
                     <Head title={`Admin - Editar ${asset.name}`} />
                     ...
                     <div className="p-6">
                            ...
                            <div className="mb-8">
                                   ...
                                   <div className="flex items-center gap-3">
                                          ...
                                          <div>
                                                 ...
                                                 <p className="mt-1 text-gray-600 dark:text-gray-400">
                                                        Actualiza los datos del modelo: {asset.name}
                                                 </p>
                                          </div>
                                   </div>
                                   ...
                                   <div className="mt-4 flex flex-wrap items-center gap-4 text-sm">
                                          ...
                                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${asset.is_active
