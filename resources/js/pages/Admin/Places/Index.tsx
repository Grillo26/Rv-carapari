                            ...
                            <div className="mb-8">
                                   <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                          ...
                                          <Link
                                                 ...
                                                 className="mt-4 md:mt-0 inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg"
                                          >
       ...
       if (totalPlaces === 0) {
              return (
                     <div className="text-center py-16">
                            ...
                            <Link
                                   href="/admin/places/create"
                                   className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg transition-all"
                            >
                                   <Plus className="h-5 w-5" />
...
function PlaceCard({ place, onToggleAvailability, onDelete }: PlaceCardProps) {
       ...
       return (
              <div className="group bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
                                   ...
                                   <div className="relative h-48 lg:h-full">
                                          ...
                                          {(place.images_count || 0) > 0 && (
                                                 <div className="absolute bottom-4 right-4">
                                                        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-white/90 text-gray-700 backdrop-blur-sm border border-white/20">
                                   ...
                                   <div className="flex flex-col h-full">
                                          <div className="flex-1">
                                                 ...
                                                 <div className="mb-3">
                                                        ...
                                                        <p className="text-sm text-gray-500 font-mono bg-gray-50 px-2 py-1 rounded mt-1 inline-block">
                                                               /{place.slug}
                                                        </p>
                                                 </div>
                                          ...
                                          <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-100">
                                                 <Link
                                                        ...
                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-lg font-medium text-sm transition-colors"
                                                 >
                                                 ...
                                                 <Link
                                                        ...
                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-700 hover:bg-gray-100 rounded-lg font-medium text-sm transition-colors"
                                                 >
                                                 ...
                                                 <Link
                                                        ...
                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 text-purple-700 hover:bg-purple-100 rounded-lg font-medium text-sm transition-colors"
                                                 >
                                                 ...
                                                 <button
                                                        ...
                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-50 text-yellow-700 hover:bg-yellow-100 rounded-lg font-medium text-sm transition-colors"
                                                 >
                                                        {place.is_available ? (
                                                               <>
                                                 ...
                                                 <button
                                                        onClick={onDelete}
                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 text-red-700 hover:bg-red-100 rounded-lg font-medium text-sm transition-colors"
                                                 >
