...
export default function EditUser({ user }: EditUserProps) {
       ...
       const handleSubmit = (e: React.FormEvent) => {
              ...
              router.post(`/admin/users/${user.id}`, submitFormData, {
                     forceFormData: true,
                     preserveScroll: true,
                     onSuccess: () => {
                                   ...
                                   <div className="flex items-center gap-3">
                                          ...
                                          <div>
                                                 ...
                                                 <p className="mt-1 text-gray-600 dark:text-gray-400">
                                                        Modificar información de <span className="font-medium">{user.name}</span>
                                                 </p>
                                          </div>
                                   </div>
                            </div>
                                                               ...
                                                               <div className="space-y-4">
                                                                             ...
                                                                             {(avatarPreview || currentAvatarUrl) ? (
                                                                                    ...
                                                                                    <div className="w-full h-48 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 flex items-center justify-center">
                                                                                           <div className="text-center">
                                                                                                  ...
                                                                                                  <p className="text-sm text-gray-500 dark:text-gray-400">Sin imagen de perfil</p>
                                                                                           </div>
                                                                                    </div>
                                                                             )}
                                                                             {avatarPreview && (
                                                                      ...
                                                                      <div className="text-center">
                                                                             <label htmlFor="avatar" className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-medium px-4 py-2 rounded-lg cursor-pointer transition-colors">
                                                                                    ...
                                                                                    {currentAvatarUrl ? 'Cambiar Imagen' : 'Seleccionar Imagen'}
                                                                             </label>
                                                                             <input
                                                                                    id="avatar"
                                                                                    name="avatar"
